 ...
 * @brief  source file to run image aquisition at 10Hz.
...
//frames 
VideoCapture cap(0);
// Mat ppm(480,640,CV_8UC3);
// Mat jpg(480,640,CV_8UC3); 
...
void *save_ppm(void *threadp)
{
    ...
    syslog(LOG_INFO,"\n\rWCET for Save PPM Thread : %f ms",wcet[2]/50);
...
//function opens ppm images and converts to jpg
void *save_jpg(void *threadp)
{
    ...
    syslog(LOG_INFO,"\n\rWCET for Save JPG Thread : %f ms",wcet[3]/2);
